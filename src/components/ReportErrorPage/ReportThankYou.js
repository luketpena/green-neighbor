      ...
      <div>
        <Dialog  aria-labelledby="customized-dialog-title" open={props.open}>
          ...
          <DialogContent dividers>
            ...
            <Typography gutterBottom>
              If there is anything else you'd like to chime in on check out our 
              <a href="https://www.facebook.com/GreenNeighborChallenge/" target="_blank" rel="noopener noreferrer">Facebook</a>
               and 
               <a href="https://twitter.com/GreenNeighborCh" target="_blank" rel="noopener noreferrer">Twitter!</a> 
            </Typography>
          </DialogContent>
          <DialogActions>
